...
export function Contact() { return <section id="contact" className="contact"><div><small>GET IN TOUCH</small><h2>CONTACT</h2><p>For original painting enquiries, commissions, exhibitions, collaborations, or press, please get in touch.</p></div><form onSubmit={(e) => e.preventDefault()}><div className="form-row"><label>First name *<input required /></label><label>Last name<input /></label></div><div className="form-row"><label>Email *<input type="email" required /></label><label>Phone<input /></label></div><label>Additional information<textarea rows={4}/></label><button type="submit">SUBMIT</button></form></section> }
