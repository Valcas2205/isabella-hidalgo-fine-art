...
export function Hero() { return <section className="hero" style={{ backgroundImage: `url(${hero})` }}><div className="hero-wash"/><div className="hero-content"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-Photoroom-UVlbKj7T4gFN6HRxBWAXiAi9m4QzJd.png" alt="Isabella Hidalgo" /></div></section> }
